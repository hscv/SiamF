...
def max2d(a: torch.Tensor) -> (torch.Tensor, torch.Tensor):
    ...
    # print ('a.size() = ', a.size())  ## [23, 255, 255]
    max_val_row, argmax_row = torch.max(a, dim=-2)
    max_val, argmax_col = torch.max(max_val_row, dim=-1)
    # print ('max_val_row.size() = ', max_val_row.size()) ## [23, 255]
    # print ('argmax_row.size() = ', argmax_row.size()) ## [23, 255]
    # print ('max_val.size() = ', max_val.size()) ## [23]
    # print ('argmax_col.size() = ', argmax_col.size()) ## [23]
